...
import 'package:rkmovies_apps/DetailScreen/checker.dart';
import 'package:rkmovies_apps/RepeatedFunction/repttext.dart';
import 'package:flutter/material.dart';
import 'package:rkmovies_apps/RepeatedFunction/searchbarfunc.dart';
import '../SectionHomeUi/movie.dart';
import '../SectionHomeUi/tvseries.dart';
import '../SectionHomeUi/upcomming.dart';
import 'package:http/http.dart' as http;
import 'package:flutter/services.dart';
import 'package:rkmovies_apps/apikey/apikey.dart';
...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        drawer: drawerfunc(),
        backgroundColor: Color.fromRGBO(12, 0, 65, 1),
        body: CustomScrollView(physics: BouncingScrollPhysics(), slivers: [
          SliverAppBar(
              backgroundColor: Color.fromRGBO(24, 5, 77, 0.894),
